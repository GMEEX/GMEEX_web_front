<template>
  <div :class="pageView">
    <div class="page-content">
      ...
      <div class="layout" v-show="!(path ==='/login') && !(path ==='/register')">
              ...
              <Menu mode="horizontal" width="auto" @on-select="changelanguage" style="height: 50px;line-height:50px;">
                  <Submenu name="lang">
                      <template slot="title" class="lang-title">
                        ...
                        <img class="lang-img" v-if="lang=='繁體中文'" src="./assets/images/lang-zh.png"></img>
                        <img class="lang-img" v-if="lang=='English'" src="./assets/images/lang-en.png"></img>
                      </template>
                      <MenuItem name="zh" class="lang-item"><img src="./assets/images/lang-zh.png"></img>繁體中文</MenuItem>
            ...
            <div class="rightwrapper">
              <poptip placement="bottom" width="120" class="appdownload" trigger="hover">
                ...
                <div class="api" slot="content">
                  <div class="ios">
                    <img src="assets/images/appdownload.png" alt="">
                    <div class="tips">
    ...
    <Drawer :closable="true" width="40" v-model="navDrawerModal" class="header_nav_mobile">
        <Menu :active-name="activeNav" width="auto" @on-select="changelanguage">
            ...
            <Submenu name="lang">
                ...
                <MenuItem name="zh" class="lang-item" style="padding-left:20px!important;"><img src="./assets/images/lang-zh.png"></img>繁體中文</MenuItem>
    ...
    <div class="footer" v-show="!(path ==='/login') && !(path ==='/register')">
      <div class="footer_content">
        <div class="footer_left">
         <!-- <img  src="./assets/images/logo-bottom.png" style="margin:0" ></img>-->
          ...
          <p>Copyright © 2019 - GMEEX.com All rights reserved.&nbsp;&nbsp;</p>
          <div class="social-list">
            <ul>
              ...
              <Tooltip content="https://weibo.com/GMEEX" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconweibo" />
                </li>
              </Tooltip>
              <Tooltip content="https://twitter.com/GMEEXGlobal" theme="dark" placement="top">
                <li>
                  <Icon type="logo-twitter" />
                </li>
              </Tooltip>
              <Tooltip content="https://medium.com/@GMEEX" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconmedium" />
                </li>
              </Tooltip>
              <Tooltip content="https://www.reddit.com/u/GMEEXglobal" theme="dark" placement="top">
                <li>
        ...
        <div class="footer_right" style="margin-left: 5%;border-left: 1px solid #243051;padding-left: 5%;">
          <ul>
            ...
            <li>
              <a target="_blank" href="https://pulse.gmeex.com/">GMEEX Pulse</a>
            </li>
            <li>
          ...
          <ul>
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">help.desk@gmeex.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">support@gmeex.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">bussiness@gmeex.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">compliance@gmeex.com</p>
                </div>
              </poptip>
            </li>
          </ul>
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "繁體中文" ? "交易中心" : "Exchange") + " - GMEEX | 每个人都可以安全、轻松地交易数字货币 | 加密货币交易平台";
          break;
        case "nav-service":
          window.document.title = (this.lang == "繁體中文" ? "公告" : "Announcement") + " - GMEEX | 每个人都可以安全、轻松地交易数字货币 | 加密货币交易平台";
          break;
        case "nav-about":
          window.document.title = (this.lang == "繁體中文" ? "关于" : "ABOUT") + " - GMEEX | 每个人都可以安全、轻松地交易数字货币 | 加密货币交易平台";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "繁體中文" ? "Soft-Finance" : "Soft-Finance") + " - GMEEX | 每个人都可以安全、轻松地交易数字货币 | 加密货币交易平台";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "繁體中文" ? "推荐计划" : "Affiliate") + " - GMEEX | 每个人都可以安全、轻松地交易数字货币 | 加密货币交易平台";
          break;
	case "nav-cexchange":
          window.document.title = (this.lang == "繁體中文" ? "奖励活动" : "Activity") + " - GMEEX | 每个人都可以安全、轻松地交易数字货币 | 加密货币交易平台";
          break;
        default:
          window.document.title = "GMEEX | 每个人都可以安全、轻松地交易数字货币 | 加密货币交易平台";
          break;
      }
    },
    $route(to, from) {
              ...
              .ivu-menu {
                a {
                  ...
                  li.ivu-menu-item.ivu-menu-item-active.ivu-menu-item-selected {
                    color: #03ca9b;
                        border-bottom: 3px solid #03ca9b;
                  }
                }
