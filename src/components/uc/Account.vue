    ...
    data() {
        ...
        return {
            ...
            bankNameList: [
                ...
                {
                    value: 'J.P. Morgan Chase Bank Berhad',
                    label: 'J.P. Morgan Chase Bank Berhad'
                },
                {
                    value: 'Bank of Taiwan',
                ...
                {
                    value: 'Chang Hwa Commercial Bank',
                    label: 'Chang Hwa Commercial Bank'
                },
                {
                    value: 'The Shanghai Commercial & Savings Bank',
                    label: 'The Shanghai Commercial & Savings Bank'
                },
                {
                    value: 'Taipei Fubon Commercial Bank',
                ...
                {
                    value: 'Bank of Kaohsiung',
                    label: 'Bank of Kaohsiung'
                },
                {
                    value: 'Mega International Commercial Bank',
                    label: 'Mega International Commercial Bank'
                },
                {
                    value: 'Taichung Commercial Bank',
                    label: 'Taichung Commercial Bank'
                },
                {
                    value: 'Kings Town Bank',
                    label: 'Kings Town Bank'
                },
                {
                    value: 'HSBC Bank (Taiwan) Limited',
                    label: 'HSBC Bank (Taiwan) Limited'
                },
                {
                    value: 'Hwatai Bank',
                    label: 'Hwatai Bank'
                ...
                {
                    value: 'COTA Commercial Bank',
                    label: 'COTA Commercial Bank'
                },
                {
                ...
                {
                    value: 'Far Eastern International Bank',
                    label: 'Far Eastern International Bank'
                },
                {
                    value: 'Hong Leong Bank',
                    label: 'Hong Leong Bank'
                ...
                {
                    value: 'Yuanta Commercial Bank',
                    label: 'Yuanta Commercial Bank'
                },
                {
                    value: 'Bank SinoPac',
                    label: 'Bank SinoPac'
                ...
                {
                    value: 'DBS Bank (Taiwan) Limited',
                    label: 'DBS Bank (Taiwan) Limited'
                },
                {
                    value: 'Taishin International Bank',
                    label: 'Taishin International Bank'
                },
                {
                    value: 'CTBC Bank',
                    label: 'CTBC Bank'
                ...
                {
                    value: 'OCBC Wing Hang Bank',
                    label: 'OCBC Wing Hang Bank'
                },
                {
                    value: 'Nanyang Commercial Bank',
                    label: 'Nanyang Commercial Bank'
                },
                {
                    value: 'China CITIC Bank International',
                    label: 'China CITIC Bank International'
                },
                {
                    value: 'CMB Wing Lung Bank',
                    label: 'CMB Wing Lung Bank'
                },
                {
                    value: 'Morgan Stanley Bank Asia',
                    label: 'Morgan Stanley Bank Asia'
                },
                {
                    value: 'Other',
                    label: 'Other'
