    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.service')}}：help.desk@gmee.com</p>
          <p>{{$t('description.support')}}：cs@gmeex.com</p>
          <p>{{$t('description.apply')}}：bussiness@gmeex.com</p>
          <p>{{$t('description.report')}}：compliance@gmeex.com</p>
          <p>{{$t('description.coop')}}：info@gmeex.com</p>
        </div>
        <div class="content1" style="border:none;">
          ...
          <p>{{$t('description.twitter')}}：https://twitter.com/GMEEXcommunity</p>
          <p>{{$t('description.biyong')}}：https://0.plus/gmeexofficial</p>
          <p>{{$t('description.telegram')}}：https://t.me/gmeex_support</p>
          <p>{{$t('description.medium')}}：https://blog.gmeex.com</p>
          <p>{{$t('description.reddit')}}：https://www.reddit.com/user/gmeex</p>
        </div>
      </div>
    </div>
  </div>
