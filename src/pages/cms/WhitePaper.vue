<template>
  <div class="pdf">
    <embed src="https://coinexchange.oss-cn-hangzhou.aliyuncs.com/BIZZANWhitePaperVer%201.0.pdf" width="100%" height="800">
...
export default {
  data() {
    return {
      src: 'https://coinexchange.oss-cn-hangzhou.aliyuncs.com/BIZZANWhitePaperVer%201.0.pdf'
    };
  },
  created: function() {
    this.init();
