    ...
    <div class="ctc_container">
      ...
      <div class="main">
          <Tabs :animated="false" style="width:100%;">
            <TabPane :label="'USD' + $t('ctc.trade')" name="all">
                      ...
                      <div class="panel panel_buy">
                        <div class="bd bd_limited">
                          <Form>
                            ...
                            <Button style="padding-bottom: 10px;padding-top: 10px;" class="bg-green" size="large" @click="buyClick">{{$t("ctc.buyin")}} USD</Button>
                          </Form>
                        </div>
                      </div>
                        ...
                        <div class="bd bd_limited">
                          <Form ref="formValidate">
                            ...
                            <p style="font-size: 12px;margin-top: -20px;text-align:right;margin-bottom: 10px;">
                              ...
                              <span>21212</span><span style="margin-left: 5px;">USD</span>
                            </p>
                            <FormItem>
                            ...
                            <Button style="padding-bottom: 10px;padding-top: 10px;" class="bg-red" size="large" @click="sellClick">{{$t("ctc.sell")}} USD</Button>
                          </Form>
                        </div>
                      </div>
                    </div>
    ...
    <Modal
        ...
        @on-ok="ok">
          ...
          <Row style="background: #27384a;padding: 10px 0px;border-radius: 5px;">
              ...
              <Col span="8">
                <p v-if="detailOrder.direction == 0" class="item-title">{{detailOrder.amount | toFixed(2)}} <span class="unit">USD</span></p>
                <p v-if="detailOrder.direction == 1" class="item-title">{{detailOrder.amount | toFixed(2)}} <span class="unit">USD</span></p>
