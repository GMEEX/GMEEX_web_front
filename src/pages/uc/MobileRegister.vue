<template>
  <div class="login_form mob-login">
    <div class="login_right">
      <div style="color: #9effc7;margin-bottom: 60px;margin-top: 60px;">
        <h1 style="border-left: 5px solid #52ffb1;padding-left: 10px;letter-spacing: 2px;line-height:30px;height:30px;">GMEEX.COM</h1>
        <p style="padding-left:15px;letter-spacing: 6px;">The home of digital asset trading</p>
        <div style="margin-left:5px;letter-spacing: 2px;margin-top: 10px;color: rgb(226, 226, 227);font-size:13px;padding: 5px 10px;">Cryptocurrency Exchange and Margin Trading</div>
      </div>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      window.document.title = (this.lang == "繁體中文" ? "新用户注册 - " : "New Register - ") + "GMEEX | Digital Assets Exchange";
      // this.getAreas();
      // this.initGtCaptcha();
    },
    initGtCaptcha() {
