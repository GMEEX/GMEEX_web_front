<template>
  <div class="container swap" :class="skin">
    <!--<div style="background-image: linear-gradient( 135deg, #FD6585 10%, #0D25B9 100%);text-align: center;height:30px;line-height:30px;letter-spacing: 1px;">请勿复制本代码,后果自负。</div>-->
    <div class="main">
              ...
              <div class="operate-login" v-if="!isLogin" style="width: 94%; margin-left:3%;">
                <span style="display: inline-block;width: 100%; text-align: center;border:1px solid #232d3a;padding: 5px 0;border-radius: 5px;">
                  ...
                  <router-link to="/login">
                    <span style="color:#aaff00;">{{$t("common.login")}}</span>
                  </router-link> /
                  <router-link to="/register">
                    <span style="color:#ffffff;">{{$t("common.register")}}</span>
                  </router-link>
                </span>
              </div>
            </div>
