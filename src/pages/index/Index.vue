<template>
  <div>
    <div id="fullpage">
     <!-- <div style="background-image: linear-gradient( 135deg, #FD6585 10%, #0D25B9 100%);text-align: center;height:30px;line-height:30px;letter-spacing: 1px;"></div>-->
      ...
      <div class="section" id="page1">
        ...
        <div class="spin-wrap banner-panel">
          <p style="text-align:center;font-size:50px;color:#ffffff;position:absolute;top: 200px;width:100%;letter-spacing:1px;text-shadow: 0px 0px 10px #232900;">{{$t("common.slogan")}}</p>
          <p style="text-align:center;font-size:20px;color:#01a781;position:absolute;top: 300px;width:100%;letter-spacing:2px;">{{$t("common.subslogan")}}</p>
...
.banner-panel{
  height:400px;background-color:#102331;overflow:hidden;position:relative;
  .activity-list{
...
#pagetips{
  .agent-panel{
    ...
    .agent-list{
      ...
      .agent-item{
        height:54px;background:#102331;width:210px;margin-left:10px;padding-right:15px;
...
#pagetips {
  background: linear-gradient(200deg,#192330,#13834a,#192330);
  padding: 0 1%;
  ...
  .page2nav {
    ...
    .brclearfix {
      ...
      li.active {
        ...
        color: #03ca9b;
        position: relative;
        border-bottom: 2px solid #03ca9b;
      }
    }
  }
  .ptjy {
...
#page5 {
  ...
  padding: 0 14%;
  position: relative;
  background: #102331 url("../../assets/images/app-download.jpg") no-repeat 0 0;
...
#page2 {
  .ptjy {
    ...
    border-bottom: 1px solid #102331!important;
    &:after{
...
.lastest-price{
  background:-webkit-linear-gradient(left,#FFFFFF,#4c5563 25%,#FFFFFF 50%,#4c5563 75%,#FFFFFF);
  color:transparent;
